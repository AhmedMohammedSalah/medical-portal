  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          {!isCollapsed && (
            <div className="flex items-center space-x-2">
              <div
                className={`w-8 h-8 ${getRoleColor()} rounded-lg flex items-center justify-center`}
              >
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        >
          <div
            className={`w-8 h-8 ${getRoleColor()} rounded-full flex items-center justify-center`}
          >
        ...
        {!isCollapsed && (
          <button
            className="w-full mt-3 flex items-center space-x-2 px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors"
